              ...
              <div className="absolute left-1/2 top-[47%] -translate-x-1/2 -translate-y-1/2">
                ...
                >
                  ...
                  <span
                    className="
                      ...
                      rounded-full
                      bg-[#BCE5F3]
                      shadow-[0_0_20px_rgba(188,229,243,0.9)]
                    "
                  />
                </motion.div>
                ...
                <div
                  className="
                    ...
                    border-white/15
                    bg-white/[0.045]
                    shadow-[0_0_100px_rgba(176,220,235,0.16)]
                    backdrop-blur-md
                    sm:h-64
                    sm:w-64
                    lg:h-72
